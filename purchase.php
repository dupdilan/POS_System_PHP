...
tr:nth-child(even){background-color: #f2f2f2}
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Create Purchase Invoice</li>
                        ...
                        <?php
                            require("php_action/addPurchaseItemModal.php");
                        ?>
                </div>
            ...
            <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><i class="glyphicon glyphicon-list"></i> &nbsp  View the Purchase Items </div>
                        <div class="panel-body">
                            ...
                            $sql = "select MAX(id) from tbl_purchase ";
                                    ...
                                    $_GET['maxid'] = $maxid;
                                //  echo $maxid;
                                 require_once("php_action/viewPurchaseItems.php");
    ...
    <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><i class="glyphicon glyphicon-list"></i> &nbsp  View the Invoice Basic Details </div>
                        ...
                        <form name="frmItems" class="form-horizontal" action="php_action/addInvoicePurchase.php" method="post">

                        <div class="form-group">
                                        <label for="txtuid" class="col-sm-3 control-label"> Purchase Invoice ID:</label>
                                        <div class="col-sm-3">
                                          <input type="number" class="form-control" id="txtInvoiceId" name="txtInvoiceId" value="<?php echo $maxid; ?>" readonly >
                                        </div>

                                        <!-- <label for="txtuname" class="col-sm-2 control-label"> Suppiler Name:</label>
                                        <div class="col-sm-3">
                        ...
                        <hr>
                        <?php
                        $sqlTot = "select sum(total) from  tbl_purchaseitems WHERE invoiceId=$maxid";
                        // echo $maxid;
                        ...
                        <div class="form-group pull-right" >
                                        ...
                                        <div class="col-sm-4">
                                         <button type="submit" class="btn btn-default"  id="btncreatePurchaseInvoice" name="btncreatePurchaseInvoice" value="createPurchaseInvoice"><i class="glyphicon glyphicon-plus"></i> Create Purchase Invoice</button>
                                         </div>
 ...
 <!--event listner-->
 <script>
document.querySelectorAll('#tablePurchaseInvoiceItems tr').forEach(e=>e.addEventListener("click",function(){
    ...
    if(confirm("Are you sure to delete the Item!")){
                                                        ...
                                                        var xmlhttp = new XMLHttpRequest();
                                                            ...
                                                            xmlhttp.open("GET", "php_action/deleteItemPurchase.php?q="+itemName+"&id="+id+"&qty="+qty, true);
                                                            xmlhttp.send();
