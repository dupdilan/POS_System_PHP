                    ...
                    <div class="col-sm-6" style="margin-bottom:20px;">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                ...
                                <div class="modal-body">
                                    <!--Form Body-->
                                            <!--Form Body-->
                                    <form  class="form-horizontal" id="frmOrder" action="php_action/addItemsToInvoice.php" method="POST">
                                ...
                                <div class="modal-footer"> 
                                    ...
                                    <button type="button" class="btn btn-primary" id="btnAddItems" name="btnAddItems" value="AddItems"><i class="glyphicon glyphicon-plus"></i>&nbsp Add To Invoice</button>
                                </div>
