<?php 
     ...
     $query = "SELECT * FROM tbl_purchase WHERE id=$id";
...
<html lang="en">
  <head>
    ...
    <title>Company_Name Purchase Invoice</title>
...
<table id="items">
 ...
 <!-- foreach($row1 as $item){
  ...
  <?php 
              $query1 = "SELECT * FROM tbl_purchaseitems WHERE invoiceId=$id";
...
<div id="terms">
  <h5>Terms</h5>
  <textarea>PURCHASE INVOICE END.</textarea>
